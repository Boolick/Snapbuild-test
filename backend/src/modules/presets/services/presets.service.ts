  ...
  private seedDefaultPresets(): void {
    const defaults: Preset[] = [
      new Preset({
        ...
        mainPrompt: 'premium minimal 3D visual, smooth clay and glass materials, studio soft lighting, isometric view, 8k resolution, octane render masterpiece',
        negativePrompt: 'clutter, noisy background, photorealistic human, low resolution, artifacts, blurry, bad topology',
        references: [
      ...
      new Preset({
        ...
        mainPrompt: 'cyberpunk aesthetic, rainy night city, intense neon reflections, volumetric magenta and cyan fog, highly detailed, cinematic lighting, unreal engine 5 render',
        negativePrompt: 'daylight, sunshine, oversaturated pastel, rustic, cartoon, blurry, low contrast',
        references: [
      ...
      new Preset({
        ...
        mainPrompt: 'anime aesthetic, lush fantasy landscape, glowing particles, vibrant clouds, detailed painted textures, cinematic composition, artstation trending',
        negativePrompt: 'photorealistic, 3d render, dark, muddy colors, deformed hands, noisy, watermark',
        references: [
      ...
      new Preset({
        ...
        mainPrompt: 'professional commercial studio photography, shot on 85mm lens, f/1.8, softbox lighting, ultra-sharp focus, natural skin texture, masterpiece, 8k raw photo',
        negativePrompt: 'cgi, 3d render, cartoon, plastic skin, distorted features, overexposed, grainy, blurry',
        references: [
      ...
      new Preset({
        ...
        mainPrompt: 'minimalist vector illustration, clean lines, flat design, modern color palette, duotone aesthetic, behance award winner, vector art',
        negativePrompt: 'gradients, photo, 3d, realistic shadows, clutter, noisy texture, complex background',
        references: [
